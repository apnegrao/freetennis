...
let durationOfCurAnimUpToImpactFrame ~o =
  ...
  | RunAnimation _ -> raise ThereIsNoImpactFrameInThisAnim
...
let setAnim ~animName  ~o ~restartIfSameAnimation = 
  let an , fr, st = 
    if 0 != (compare animName o.o3d_curAnimName) then animName, 0, Animated 0.0
    else if restartIfSameAnimation then animName, 0, Animated 0.0
    else o.o3d_curAnimName, o.o3d_curFrameIdx, o.o3d_animState
  in
...
let computeWalkAnim ~footTarget ~curPos ~dirsign   = 
  ...
  let appropriateZAxis  = vec2dCreate (0.0)  (dirsign *. (-. 1.0)) in
  let appropriateXAxis  = vec2dCreate (dirsign *. (-. 1.0)) 0.0 in
  let angZ = smallestAngleBetween appropriateZAxis dir in
  assert(angZ >= 0.0);
  if angZ < degToRad 40.0 then "su"
  else if angZ < degToRad (130.0) then
    let angX = smallestAngleBetween appropriateXAxis dir in
    if angX < degToRad 90.0 then "sinistra"
    else "destra"
  else "giu"
...
let loadAnimdata =
  ...
  let fma2 = 0.07 in
  let fm = 0.08 in
  (*let fm2 = fm *. 2.0 in * XXX: Unused variable *)
  let fm3 = fm *. 3.0 in
  let fm4 = fm *. 4.0 in
  (*let fm8 = fm *. 8.0 in * XXX: Unused variable *)
  ...
  [ gfxDir ^ "/Battesa", NoImpactFrame, [| fma2; fma2; fma2; fma2 |], noScale;
    ...
    gfxDir ^ "/Bservizio", Service (5, 10), [| fm *. 16.0; fm; fm;fm;fm;fm;fm;
                                               fm12;fm12;fm12;fm12;fm12;fm;fm |],
        (0.37, 0.5);
    ...
    gfxDir ^ "/Adritto", NotService 8, [|fm23; fm23; fm23;fm23; fm23; fm23; fm23;
                                         fm23; fm23; fm; fm3|], noScale;
    gfxDir ^ "/Arovescio", NotService 11, [|fm23; fm23; fm23;fm23; fm23; fm23;
                                            fm12; fm12; fm14;fm14; fm14; fm14;
                                            fm23; fm3|], noScale;
    gfxDir ^ "/Arovescioback", NotService 4, [|fm; fm; fm; fm;fm; fm; fm|], 
        noScale;
    gfxDir ^ "/Adrittoback", NotService 4, [|fm; fm; fm; fm;fm; fm|], noScale;
    gfxDir ^ "/Adrittov", NotService 4, [|fm12; fm12; fm; fm12; fm12;fm|],
        noScale;
    gfxDir ^ "/Arovesciov", NotService 5, [|fm12; fm12; fm; fm12; fm12;fm12; fm|],
        noScale;
    gfxDir ^ "/Aservizio", Service (7, 19), [| fm *. 16.0;fm; fm; fm; fm;fm; fm;
                                               fm12 ; fm12; fm12;fm12;fm12;fm12;
                                               fm12;fm12;fm12;fm12;fm12;fm12;fm12;
                                               fm12;fm12;fm12;fm12;fm12|],
        (0.4, 0.5);
