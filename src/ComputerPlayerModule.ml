...
(** ---- Functions ---- **)
let createComputerPlayer ~playsInTopmostCourtHalf ~plName ~scoreIndex ~startPos  
	~mat ~ob ~distanceOfBounceFromLine =
	let commonData = createPlayerCommonData ~plName in
	CP {
	cp_name = plName;
	cp_distanceOfBounceFromLine = distanceOfBounceFromLine;
