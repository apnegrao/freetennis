...
(* Why isn't the fatigueData in the playerCommon? I think the playerCommon data are all constants. 
...
(** Common again...this shoudn't be this way **)
...
(* This could be a common function!*)
let resetFatigue pl  = 
    match pl with
	| HP h ->
